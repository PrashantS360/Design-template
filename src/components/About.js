...
const About = () => {
    return (
        <div className='flex flex-col items-center'>
            ...
            <input type="text" className='outline-none border-2 border-black mt-5 px-5 py-2 rounded-full min-w-[55%] text-center sm:-ml-28' placeholder='Search service, blog and many more...' />
            <button className='py-2 px-5 min-w-[17%] border-2 border-black rounded-full max-w-[165px] bg-black text-white relative -top-[2.7rem] left-[24%] '>Search</button>
